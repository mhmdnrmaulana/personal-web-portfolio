...
const Loading = (classProps?: string) => (
  <div className={`w-full min-h-[300px] flex justify-center items-center ${classProps}`}>
    <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 animate-spin mr-3" viewBox="0 0 24 24" strokeWidth="1" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
