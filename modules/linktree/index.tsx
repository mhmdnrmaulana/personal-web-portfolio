...
export default function LinkTrComponents() {
  return (
    <Container>
      <Compo>
        <div className="w-full md:w-1/2 mx-auto border-2 border-neutral-500 rounded-md relative overflow-hidden">
          <div className="w-full h-[20vh] bg-[url('/images/project1.webp')] blur-[3px] bg-cover bg-top relative -z-20" />
